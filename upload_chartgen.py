...
def upload_all(api: HfApi, repo_id: str, files: List[Tuple[str, str]], prefix: str = "chartgen", commit_prefix: str = "Add") -> None:
    failed: List[str] = []
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload chartgen files to Hugging Face dataset repo.")
    parser.add_argument("--repo-id", default="JiahuiGengNLP/MMCoIR", help="目标数据集仓库 ID")
    parser.add_argument("--local-root", default="MMCoIR/chartgen", help="本地文件根目录")
    parser.add_argument("--prefix", default="chartgen", help="仓库中的子目录前缀")
