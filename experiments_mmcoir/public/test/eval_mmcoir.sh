...
set -euo pipefail
cd /pfss/mlde/workspaces/mlde_wsp_DocQuery/cai/MMCodeRetrieval
...
OUTPUT_BASEDIR=${OUTPUT_BASEDIR:-exps}
...
MODEL_SPECS+=( "$OUTPUT_BASEDIR/Qwen2vl_2B.imageonly.image.lora16.bf16true.BS16.IB2.GCq8p8.NormTrue.Temp002.lr5e-5.linear.step10000warm100;qwen2_vl;$OUTPUT_BASEDIR/Qwen2vl_2B" )
