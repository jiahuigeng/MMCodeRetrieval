...
############################################################
# Configurable parameters (used to auto-name EXP_NAME)
############################################################
...
DATASET_CONFIG=experiments_mmcoir/public/train/image.yaml
...
# Task tag for visibility in experiment name
TASK_TAG=imageonly

# Auto-construct experiment name based on parameters above
# Format temperature to compact string (e.g., 0.02 -> 002)
